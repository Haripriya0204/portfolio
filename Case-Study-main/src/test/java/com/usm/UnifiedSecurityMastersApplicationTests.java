...
class UnifiedSecurityMastersApplicationTests {
	 ...
	 * SecurityMaster("NSE","IND","INR","INE144J01027",
	 ...
	 * when(repository.findBySectorContaining(sector)).thenReturn(Stream.of( new
	 * SecurityMaster("NSE", "IND", "INR", "INE144J01027", "20MICRONS",
	 * "20 Microns Limited", "EQ", "Metals and Mining", "Minerals & Mining",
	 * "151040"), new SecurityMaster("NSE", "IND", "INR", "INE423A01024",
	 * "ADANIENT", "Adani Enterprises Limited", "EQ", "Metals and Mining",
	 * "Metals & Mineral Trading", "151040")) .collect(Collectors.toList()));
