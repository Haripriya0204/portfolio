...
public class SecurityMaster {
	...
	public SecurityMaster(String exchange, String country, String currency, String isinNumber, String symbol,
			String nameOfCompany, String series, String sector, String industry, String gics, String assetClass,
			String subAssetClass, String equity) {
		super();
	...
	public String toString() {
		return "SecurityMaster [exchange=" + exchange + ", country=" + country + ", currency=" + currency
				...
				+ series + ", sector=" + sector + ", industry=" + industry + ", gics=" + gics + ", assetClass="
				+ assetClass + ", subAssetClass=" + subAssetClass + ", equity=" + equity + ", closePrice=" + closePrice
				+ ", lastPrice=" + lastPrice + "]";
	}
